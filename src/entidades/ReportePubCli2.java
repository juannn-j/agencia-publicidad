...
public class ReportePubCli2 {
	...
	public ReportePubCli2() {
		super();
	}

	public ReportePubCli2(int id_cli, String nombre_cli, int id_pub, String desc_pub, String tipo_pub, String fecha) {
		super();
		this.id_cli = id_cli;
